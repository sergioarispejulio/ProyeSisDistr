...
/**
 * Jersey REST client generated for REST resource:CompraCantidadFacadeREST
 * [servicios.compracantidad]<br>
 * USAGE:
 * <pre>
 *        Sucursal3_CompraCantidad client = new Sucursal3_CompraCantidad();
 ...
 * @author SergioArispe
 */
public class Sucursal3_CompraCantidad {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/Servicios_Sucursal3/webresources";

    public Sucursal3_CompraCantidad() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("servicios.compracantidad");
    }
